@extends('layouts.app')
@section('title','Tambah Data Draft Laporan Pemeriksaan')
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Form Tambah Data Draft Laporan Pemeriksaan</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Draft Laporan Pemeriksaan</li>
          <li class="breadcrumb-item active">Tambah Draft Laporan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tambah Draft Laporan Baru</h5>
              
              @include('partial.dangeralert')
              <form action="{{ route('draftlaporanpemeriksaan.store') }}" method="post" class="row g-3" >
                  @csrf
                ...
                <div class="col-md-12">
                  ...
                  <select id="" name="idJenisPemeriksaan" class="form-control @error('idJenisPemeriksaan') is-invalid @enderror">
                    ...
                    @foreach($getDataJenisPemeriksaan as $jp)
                        <option value="{{ $jp->id }}" {{ old('idJenisPemeriksaan') == $jp->id ? 'selected':''  }}>{{ $jp->namaJenisPemeriksaan }}</option>
                    @endforeach
                ...
                <div class="col-md-12">
                  ...
                  <textarea name="laporanNormal" id="laporanNormal" class="form-control @error('laporanNormal') is-invalid @enderror"></textarea>
                  <!-- Error Message untuk tempat lahir -->
                  @error('laporanNormal')
                    <div class="invalid-feedback" role="alert">
                        {{ $message }}
