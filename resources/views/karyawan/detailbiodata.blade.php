@extends('layouts.app')
@section('title','Welcome to Detail Biodata Karyawan')
@section('setCollapsed', '')
@section('content')
<main id="main" class="main">

    <div class="pagetitle">
      <h1>Form Detail Profil Karyawan</h1>
      <nav>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('detailbiokaryawan.store') }}" method="post" class="row g-3" enctype="multipart/form-data">
                  @csrf
                <div class="col-md-6">
