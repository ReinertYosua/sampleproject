                        ...
                        <tbody>
                            @foreach($datadaftarperiksa as $dp)
                                <tr>
                                    ...
                                    <td><a href="{{ route('file.download', basename($dp->fileLampiran)) }}" class="btn btn-sm btn-primary">Download {{ basename($dp->fileLampiran) }}</a></td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Aksi">
                                            <a href="{{ route('pendaftaranpemeriksaan.edit', $dp->id)  }}" class="btn btn-sm btn-primary me-2">Edit</a>
