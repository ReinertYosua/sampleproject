...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Form Input Hasil Pemeriksaan Pasien</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Daftar Hasil Pemeriksaan</li>
          <li class="breadcrumb-item active">Input Hasil Pemeriksaan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <h5 class="card-title">Input Hasil Pemeriksaan Pasien</h5>
                </div>
                <div class="col-md-6">
                                    ...
                                    <td>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="laporan[]" id="laporan{{ $index }}" class="form-control @error('laporan.{{ $index }}') is-invalid @enderror">{{ $gds->laporan }}</textarea>
                                            </div>
                                        </div>
                                        @php $index++ @endphp
